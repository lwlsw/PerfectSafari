...
- (instancetype)init
{
    ...
    if (self)
	{
        ...
        self.closeSafariButton = [[UIBarButtonItem alloc] initWithTitle: @"Close Safari" style: UIBarButtonItemStylePlain target: self action: @selector(closeSafari)];
        self.closeSafariButton.tintColor = [UIColor blackColor];
